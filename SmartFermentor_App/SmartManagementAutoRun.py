import sys, time
from MonitorConsole.SmartManagementInterface import SmartManagementInterface
...
if __name__ == '__main__':
    ...
    interfaceController = SmartManagementInterface()
    ...
    interfaceController.geometry('1366x768-5-20')
    #offsetLocation = 50
