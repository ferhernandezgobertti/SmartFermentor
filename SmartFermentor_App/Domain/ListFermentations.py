...
class ListFermentations():
    ...
    def loadJSONData(self, dataToLoad):
        ...
        fermentationData.isConnectionChecked = dataToLoad['connectionStatus']
        fermentationData.isCalibrated = dataToLoad['calibrationStatus']
        fermentationData.isLiquidExpulsed = dataToLoad['liquidStatus']
        fermentationData.isVelocityControlOnFreeWheel = dataToLoad['velocityFreeWheel']
        fermentationData.isTemperatureControlOnFreeWheel = dataToLoad['temperatureFreeWheel']
        fermentationData.isPotentialHydrogenControlOnFreeWheel = dataToLoad['potentialHydrogenFreeWheel']
