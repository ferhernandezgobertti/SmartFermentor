...
if [ "$1" = "PON" ]; then
    if [ ! -e /sys/class/gpio/gpio13/value ]; then
        ...
        b=$(cat /sys/class/gpio/gpio13/value)
        if [ "$b" = "0" ]; then
            sudo echo "1" > /sys/class/gpio/gpio13/value
        else
...
if [ "$1" = "EXT" ]; then
    if [ ! -e /sys/class/gpio/gpio16/value ]; then
        ...
        b=$(cat /sys/class/gpio/gpio16/value)
        if [ "$b" = "0" ]; then
            sudo echo "1" > /sys/class/gpio/gpio16/value
        else
...
if [ "$1" = "TEM" ]; then
    if [ ! -e /sys/class/gpio/gpio12/value ]; then
        ...
        b=$(cat /sys/class/gpio/gpio12/value)
        if [ "$b" = "0" ]; then
            sudo echo "1" > /sys/class/gpio/gpio12/value
        else
...
if [ "$1" = "ERR" ]; then
    if [ ! -e /sys/class/gpio/gpio5/value ]; then
        ...
        b=$(cat /sys/class/gpio/gpio5/value)
        if [ "$b" = "0" ]; then
            sudo echo "1" > /sys/class/gpio/gpio5/value
        else
...
if [ "$1" = "POT" ]; then
    if [ ! -e /sys/class/gpio/gpio26/value ]; then
        ...
        b=$(cat /sys/class/gpio/gpio26/value)
        if [ "$b" = "0" ]; then
            sudo echo "1" > /sys/class/gpio/gpio26/value
        else
